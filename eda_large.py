...
# Load ratings.csv
ratings = spark.read.csv("hdfs:///user/ml9542_nyu_edu/ml-latest/ratings.csv", header=True, inferSchema=True)

# Load movies.csv
movies = spark.read.csv("hdfs:///user/ml9542_nyu_edu/ml-latest/movies.csv", header=True, inferSchema=True)

# Load tags.csv
tags = spark.read.csv("hdfs:///user/ml9542_nyu_edu/ml-latest/tags.csv", header=True, inferSchema=True)

# Load links.csv
links = spark.read.csv("hdfs:///user/ml9542_nyu_edu/ml-latest/links.csv", header=True, inferSchema=True)
